...
namespace App\Component\perfctl\src\services;

use App\Constants\ResponseCode;
use Illuminate\Contracts\Container\BindingResolutionException;
use App\Component\perfctl\src\constants\PerfctlConstants;
...
class ConnectctlService extends WebBaseService
{
    ...
    public function connectCtl($liveInfo, $thirdId = null)
    {
        ...
        vss_logger()->info('perfctl_connect_data', ['il_id' => $ilId, 'app' => $appData, 'account' => $accountData]);
        ...
        if (!$inTime && ($appRatio >= PerfctlConstants::CONNECT_RATIO
            ...
            vss_logger()->info(
                'perfctl_remain_connect_datacount',
                ['key' => PerfctlConstants::QUEUE_PERFCTLCTL_ILID . $ilId, 'account_data' => $accountData, 'app_data' => $appData]
            );
            //账户连接数耗尽 推入队列等待
