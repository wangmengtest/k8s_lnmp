    ...
    public function syncLiveAttends()
    {
        ...
        while (true) {
            ...
            foreach ($list as $item) {
                ...
                vss_model()->getRoomAttendsAllModel()->syncData($roomInfo, $item, self::DATA_TYPE_LIVE);
    ...
    public function syncInavAttends()
    {
        ...
        while (true) {
            ...
            foreach ($list as $item) {
                ...
                vss_model()->getRoomAttendsAllModel()->syncData($roomInfo, $item, self::DATA_TYPE_INAV);
                $syncCount['create_count'] += $result['create_count'];
                $syncCount['update_count'] += $result['update_count'];
            }
        }
