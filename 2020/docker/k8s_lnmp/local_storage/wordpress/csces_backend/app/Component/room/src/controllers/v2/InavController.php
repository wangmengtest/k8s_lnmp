...
class InavController extends BaseController
{
    ...
    public function agreeApplyAction()
    {
        ...
        if (!in_array($join_user->role_name, [RoomJoinRoleNameConstant::HOST, RoomJoinRoleNameConstant::ASSISTANT])) {
            $this->fail(ResponseCode::AUTH_NOT_PERMISSION);
        }
    ...
    public function inviteAction()
    {
        ...
        if (!in_array($receive_join_user->role_name, [
            ...
            RoomJoinRoleNameConstant::FLYING,
        ])) {
            $this->fail(ResponseCode::AUTH_NOT_PERMISSION);
        }
        vss_service()->getInavService()->sendInvite($receive_join_user, $join_user->role_name);
        $this->success();
    }
    ...
    public function nospeakAction()
    {
        ...
        if (in_array($join_user->role_name, [RoomJoinRoleNameConstant::HOST, RoomJoinRoleNameConstant::ASSISTANT]) || $receive_join_user->join_id == $join_user->join_id) {
    ...
    public function applyAction()
    {
        ...
        if ($join_user->role_name == RoomJoinRoleNameConstant::USER) {
            ...
            $join_user->role_name,
            [RoomJoinRoleNameConstant::GUEST, RoomJoinRoleNameConstant::ASSISTANT, RoomJoinRoleNameConstant::FLYING]
        )) {
    ...
    public function setDesktopAction()
    {
        ...
        if (!in_array(
            $join_user->role_name,
            [
                \App\Component\room\src\constants\RoomJoinRoleNameConstant::GUEST,
                \App\Component\room\src\constants\RoomJoinRoleNameConstant::HOST
            ]
        )) {
            $this->fail(ResponseCode::AUTH_NOT_PERMISSION);
        }
