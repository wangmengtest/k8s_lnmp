...
class StatController extends BaseController
{
    ...
    public function liveAttendAction()
    {
        ...
        foreach ($data ?: [] as $key => $value) {
            $st[] = [
                ...
                //'watch_count'         => ($value['pv_num'] < ($value['uv_num'] + 1)) ? ($value['uv_num'] + 1) : $value['pv_num'],
                //'watch_account_count' => $value['uv_num'] + 1, // 加上主持人
                'watch_count'         => $value['pv_num'],//不包括主持人
                'watch_account_count' => $value['uv_num'],//不包括主持人
            ];
        }
        $this->success($st);
    }
    ...
    public function uvListAction(){
        ...
        //vss_service()->getStatService()->exportUvData(['params'=>'{"il_id":"3","account_id":1,"start_time":"2021-09-13","end_time":"2021-09-23","status":"1"}', 'title'=>'	["\u7528\u6237\u540d\u79f0","\u7528\u6237\u7c7b\u578b","\u5355\u4f4d","\u90e8\u95e8","\u89c2\u770b\u65f6\u957f"]'], 'test');
        $data = vss_service()->getStatService()->getUvListsByFilter($params, $this->accountInfo);
        $this->success($data);
    }
}
