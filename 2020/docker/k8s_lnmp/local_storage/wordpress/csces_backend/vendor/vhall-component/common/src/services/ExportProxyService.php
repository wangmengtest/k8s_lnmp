...
use vhallComponent\common\services\exports\ExportCsv;
use vhallComponent\common\services\exports\ExportExcel;
use vhallComponent\common\services\exports\ExportInterface;
...
export:
  ...
  my: # 自定义导出配置， 下面的配置会传给 class 的构造函数
    class: vhallComponent\common\services\exports\ExportCsv # 自定义导出类
    use_cache: true
    max_cache_row: 100
 ...
 * @package vhallComponent\common\services
 *
